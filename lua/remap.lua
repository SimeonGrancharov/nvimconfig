...
local float_term = require("utils.float-term")
...
-- floating terminals
keymap.set("n", "<leader>bt", function() float_term.open("btop") end, { desc = "Open btop" })
keymap.set({"n", "t"}, "<leader>gh", function() float_term.toggle("gh dash") end, { desc = "Toggle gh dash" })
